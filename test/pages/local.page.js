...
function formatElementStatus(elementJson){
    return ` Element status=${elementJson.state} & selector=${elementJson.selector}  `; 
}
...
var localPage = Object.create(page, {
     ...
     */
    open: { value: function() {
        page.openUrl.call(this, 'file:///C:/dev/mySite/test.html');
 ...
 //           console.log("Browser %j ",browser);
    ...
    //        console.log("btns: " + btns);
            ...
            console.log(console.log("In ERROR: for B3 - BTN JSON '%s' ",formatElementStatus(btn3)));    
            console.log(error);    
        }
        //this.btn2.click();
